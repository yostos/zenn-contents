...
ITプロジェクトの失敗率は決して低くありません。Standish GroupのCHAOS Report 2020によれば、ITプロジェクトの約70%が当初の目標を達成できないとされています。特に、知見をもった要員が途絶えドキュメンテーションも十分でないシステムからの移行は、その中でも最も困難なカテゴリに属します。
