...
- 2026-02-15: サンプルガイドライン紹介セクションを追加
- 2026-01-29: 初版公開
...
## 【追記 2026-02-15】サンプルガイドラインを公開しました

本チェックリストを使って、架空の非営利団体（年間予算15億円規模）を想定した**サンプルガイドライン**を作成しました。チェックリストの各項目を実際のガイドライン文書としてどう書き下ろせばよいか、具体的な完成イメージを確認できます。

https://codedchords.dev/blog/2026/02/genai-guideline-sample/

チェックリストの「定義例」だけでは全体像が掴みにくいという方は、こちらを雛形として活用してください。
